...
export default function FeaturedProductCard({
  ...
  return (
    <Card className="rounded-2xl bg-purple-300/40 group hover:-translate-y-2 transition-transform duration-300 ease-out hover:shadow-lg">
      <CardContent className="flex flex-col gap-4 items-center text-center sm:items-start sm:text-left">
        ...
        <p className="text-sm text-gray-800 mt-2 line-clamp-3 sm:line-clamp-2">
          {description}
        </p>
