      ...
      <>
        <div className="max-w-7xl mx-auto py-16 px-6 lg:px-16 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <div className="bg-purple-200 dark:bg-purple-800 rounded-lg shadow-md p-4 flex flex-col items-center cursor-pointer transition-transform duration-300 hover:scale-105">
              <Image
                src="/images/arte.jpg"
                alt="Subasta 1"
                width={64}
                ...
                priority
              />
              <p className="text-lg text-purple-800 dark:text-blue-300">Arte</p>
            </div>
            <div className="bg-purple-200 dark:bg-purple-800 rounded-lg shadow-md p-4 flex flex-col items-center cursor-pointer transition-transform duration-300 hover:scale-105">
              <Image
                ...
                priority
              />
              <p className="text-lg text-purple-800 dark:text-blue-300">
                Automoviles
              </p>
            </div>
            <div className="bg-purple-200 dark:bg-purple-800 rounded-lg shadow-md p-4 flex flex-col items-center cursor-pointer transition-transform duration-300 hover:scale-105">
