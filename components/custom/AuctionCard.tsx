...
interface AuctionCardProps {
  id: string // Corregido: String -> string (tipo primitivo)
  title: string
  category: string
  price: number
  image: string
...
export default function AuctionCard({ id, title, category, price, image, startDate, endsIn, currentBids }: AuctionCardProps) {
  return (
