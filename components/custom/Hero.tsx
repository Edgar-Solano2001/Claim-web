        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl md:text-6xl font-bold">
              Bienvenido a <span className="text-[#7033ff]">Claim</span>
            </h1>
            ...
            <button className="bg-[#7033ff] hover:bg-[#7033ff]/90 text-white font-semibold px-6 py-3 rounded-lg transition">
              Explorar Subastas
            </button>
          </div>
