...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (!auth) {
        toast.error('No se pudo iniciar sesión: configuración de autenticación no disponible.');
        setLoading(false);
        return;
      }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!auth || !db) {
        setError('Configuración de autenticación o base de datos no disponible.');
        toast.error('Configuración de autenticación o base de datos no disponible.');
        setLoading(false);
        return;
      }
